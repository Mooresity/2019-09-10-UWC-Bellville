...
{% endcomment %}
<p id="accessibility">
  <strong>Registration:</strong> Please complete the <ahref="https://forms.gle/ytMzibWZQKXN8KTb7">registration form</a> . Limited space is available. Places will be allocated on a first come, first served principle.
</p>
